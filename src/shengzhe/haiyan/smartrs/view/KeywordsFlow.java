    ...
    private boolean show() {  
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0 && enableShow) {  
            ...
            for (int i = 0; i < size; i++) {  
                ...
                // 随机颜色   
                int[] colorArr = {0xff993399,0xffcc3399,0xff777777,0xffff6666,0xffffcccc,0xffccff99,0xffccff99};
                int index =(int)(Math.random()*colorArr.length);
                int ranColor = colorArr[index];
                ...
                txt.setShadowLayer(2, 2, 2, 0x2f000000);  
