...
public class TagSearchActivity extends BaseActivity implements OnClickListener {
	...
	private void setEvent() {
		// TODO Auto-generated method stub
		likename = getIntent().getExtras().getString("tag");
...
//		}
		...
		adapter = new MenuAdapter(TagSearchActivity.this, listData);
		...
		staggeredGridView
				.setOnRefreshListener(new OnRefreshListener<StaggeredGridView>() {
					...
					public void onRefresh(
						...
						sb.append(ServerUrl.GET_MENU_BY_TYPE_NAME);
//						sb.append("?");
//						sb.append("likename=");
